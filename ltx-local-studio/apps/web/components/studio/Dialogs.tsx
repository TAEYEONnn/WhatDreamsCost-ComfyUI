    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60">
      <div className="bg-[#111] border border-[#222] rounded-lg p-5 w-80 space-y-4">
        ...
        <div className="space-y-1">
          <label className="text-[10px] text-[#555] uppercase tracking-wider">Project Name</label>
          <input
            autoFocus
            value={name}
        ...
        <div className="space-y-1">
          <label className="text-[10px] text-[#555] uppercase tracking-wider">Aspect Ratio</label>
          <select
            value={aspectRatio}
        ...
        <div className="flex gap-2 justify-end">
          <button onClick={onClose} className="text-xs text-[#666] hover:text-white px-3 py-1.5 rounded hover:bg-[#1a1a1a] transition-colors">
            Cancel
          </button>
          <button onClick={handleCreate} disabled={!name.trim()} className="text-xs bg-blue-700 hover:bg-blue-600 disabled:opacity-40 text-white px-3 py-1.5 rounded transition-colors">
            Create
          </button>
        </div>
      </div>
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60">
      <div className="bg-[#111] border border-[#222] rounded-lg p-5 w-80 space-y-4">
        ...
        <label className="flex flex-col items-center justify-center border border-dashed border-[#333] rounded-lg p-6 cursor-pointer hover:border-[#444] transition-colors">
          ...
          <span className="text-xs text-[#666]">Click to select JSON file</span>
